...
export const metadata: Metadata = {
  title: 'Best Rezi Alternative - WorthApply | Evidence-Backed Resume Analysis',
  description: 'Looking for a Rezi alternative? WorthApply analyzes job fit first and tailors based on real experience—no template-based fabrication. Free plan available.',
};
...
export default function ReziAlternativePage() {
  const alternativeSchema = {
    ...
    "@type": "WebPage",
    "name": "Best Rezi Alternative - WorthApply",
    "description": "WorthApply is a Rezi alternative that analyzes job fit before tailoring, with evidence-backed analysis suggestions.",
    "about": {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Breadcrumbs
            items={[
              ...
              { label: 'Rezi Alternative', href: '/alternative/rezi-alternative' }
            ]}
          />
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[4.5rem] font-extrabold text-[#171411] dark:text-gray-100 tracking-tight leading-[1.0] mb-4">
              The Best Rezi Alternative
            </h1>
            <p className="text-lg text-[#6e665f] dark:text-gray-300 leading-relaxed max-w-3xl mx-auto mb-8">
              Go beyond keyword matching. Analyze job fit before you invest hours tailoring—with evidence-backed analysis that never fabricates experience.
            </p>
          ...
          <div className="mb-16 bg-gray-50 dark:bg-gray-900 rounded-3xl p-12">
            <h2 className="text-3xl lg:text-4xl font-extrabold text-[#171411] dark:text-gray-100 tracking-tight leading-[1.1] mb-8 text-center">
              Why Job Seekers Switch from Rezi to WorthApply
            </h2>
            <StaggerGroup className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#171411] dark:text-gray-100 mb-2">Fit-First Approach</h3>
                <p className="text-[#6e665f] dark:text-gray-400">
                  Analyze whether a job is worth applying to before spending hours tailoring. Rezi only checks keywords after you&apos;ve already decided.
                </p>
              </div>
              </FadeUp>
              <FadeUp>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#171411] dark:text-gray-100 mb-2">Better Free Plan</h3>
                <p className="text-[#6e665f] dark:text-gray-400">
                  Free forever plan with 3 analyses per month. Rezi limits you to a short trial then requires payment.
                </p>
              </div>
              </FadeUp>
            </StaggerGroup>
              ...
              <div className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-900/30 rounded-2xl p-8">
                ...
                <ul className="space-y-3 text-[#3d362f] dark:text-gray-300">
                  <li className="flex items-start gap-2">
                    ...
                    <span>LinkedIn profile optimization (WorthApply focuses on resumes + job applications)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 mt-1">•</span>
                    <span>Cover letter templates library (WorthApply generates custom letters, not templates)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 mt-1">•</span>
                    <span>Resume samples by industry (we tailor your actual resume instead)</span>
                  </li>
                </ul>
              </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-900">
                  ...
                  <td className="text-center py-4 px-4"><span className="text-sm font-semibold text-[#171411] dark:text-gray-100">$29</span></td>
                </tr>
                <tr>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6e665f] dark:text-gray-400">Use the same resume you optimized in Rezi. We&apos;ll analyze it from a fit-first perspective.</p>
                  </div>
                </div>
                <div className="flex gap-4">
