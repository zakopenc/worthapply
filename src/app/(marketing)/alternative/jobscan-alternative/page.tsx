...
export const metadata: Metadata = {
  title: 'Best Jobscan Alternative - WorthApply | Fit-First Resume Analysis',
  description: 'Looking for a Jobscan alternative? WorthApply goes beyond keyword matching with fit-first analysis and evidence-backed resume tailoring. Free forever plan available.',
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <Breadcrumbs
            items={[
              ...
              { label: 'Jobscan Alternative', href: '/alternative/jobscan-alternative' }
            ]}
          />
          ...
          <div className="mb-16 bg-gray-50 dark:bg-gray-900 rounded-3xl p-12">
            <h2 className="text-3xl lg:text-4xl font-extrabold text-[#171411] dark:text-gray-100 tracking-tight leading-[1.1] mb-8 text-center">
              Why Job Seekers Switch from Jobscan to WorthApply
            </h2>
            <StaggerGroup className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-[#6e665f] dark:text-gray-400">
                  Analyze whether a job is worth applying to before spending hours tailoring. Jobscan only checks keywords after you&apos;ve already decided.
                </p>
              </div>
              </FadeUp>
              <FadeUp>
              ...
              <div className="text-center">
                ...
                <p className="text-[#6e665f] dark:text-gray-400">
                  Free forever plan with 3 analyses per month. Jobscan limits you to a short trial then requires payment.
                </p>
              </div>
              </FadeUp>
            </StaggerGroup>
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100 dark:border-gray-900">
                  ...
                  <td className="text-center py-4 px-4"><span className="text-sm font-semibold text-[#171411] dark:text-gray-100">$49</span></td>
                </tr>
                <tr>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#6e665f] dark:text-gray-400">Use the same resume you optimized in Jobscan. We&apos;ll analyze it from a fit-first perspective.</p>
                  </div>
                </div>
                <div className="flex gap-4">
