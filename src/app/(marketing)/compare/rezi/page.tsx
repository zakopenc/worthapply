...
export const metadata: Metadata = {
  title: 'WorthApply vs Rezi - Which Resume Builder is Better?',
  description: 'Compare WorthApply and Rezi for expert resume building, ATS optimization, and job application strategy. Fit-first vs template-based approach.',
};
...
export default function CompareReziPage() {
  const comparisonSchema = {
    ...
    "@type": "WebPage",
    "name": "WorthApply vs Rezi Comparison",
    "description": "Compare WorthApply and Rezi for expert resume building, ATS optimization, and job application strategy.",
    "about": {
      "@type": "Thing",
      "name": "expert resume builder comparison"
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Breadcrumbs
          items={[
            ...
            { label: 'WorthApply vs Rezi', href: '/compare/rezi' }
          ]}
        />
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <div className="px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-full">
              <span className="text-sm font-semibold text-[#3d362f] dark:text-gray-300">Rezi</span>
            </div>
          </div>
          ...
          <p className="text-lg text-[#6e665f] dark:text-gray-300 leading-relaxed max-w-3xl mx-auto">
            Strategic fit analysis vs expert resume templates: Which helps you land better roles faster?
          </p>
        </div>
        </RevealOnScroll>
        ...
        <StaggerGroup className="grid md:grid-cols-2 gap-8 mb-16">
          <FadeUp><div className="bg-secondary/5 border border-secondary/20 rounded-2xl p-8">
            ...
            <p className="text-[#3d362f] dark:text-gray-300 mb-4">
              <strong>Best for:</strong> Job seekers who want to evaluate fit before tailoring, with evidence-backed resume improvements grounded in real experience.
            </p>
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-secondary flex-shrink-0" weight="bold" />
                <span className="text-sm text-[#3d362f] dark:text-gray-300">No fabricated experience</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-secondary flex-shrink-0" weight="bold" />
          ...
          <FadeUp><div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-extrabold text-[#171411] dark:text-gray-100 tracking-tight leading-[1.1]">Rezi</h2>
            </div>
            <p className="text-[#3d362f] dark:text-gray-300 mb-4">
              <strong>Best for:</strong> Job seekers who want Professional resume creation from scratch with templates and ATS scoring.
            </p>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#6e665f] dark:text-gray-400 flex-shrink-0" weight="bold" />
                <span className="text-sm text-[#3d362f] dark:text-gray-300">expert resume generation</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#6e665f] dark:text-gray-400 flex-shrink-0" weight="bold" />
                <span className="text-sm text-[#3d362f] dark:text-gray-300">ATS-friendly templates</span>
              </div>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-[#6e665f] dark:text-gray-400 flex-shrink-0" weight="bold" />
                <span className="text-sm text-[#3d362f] dark:text-gray-300">Resume score</span>
              </div>
            </div>
          </div></FadeUp>
        </StaggerGroup>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-800">
                ...
                <th className="text-center py-4 px-4 font-bold text-[#6e665f] dark:text-gray-400">Rezi</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr className="border-b border-gray-100 dark:border-gray-900">
                <td className="py-4 pr-4 text-[#3d362f] dark:text-gray-300">expert resume generation</td>
                <td className="text-center py-4 px-4"><Check className="w-6 h-6 text-green-600 mx-auto" weight="bold" /></td>
                <td className="text-center py-4 px-4"><Check className="w-6 h-6 text-green-600 mx-auto" weight="bold" /></td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-gray-900">
                <td className="py-4 pr-4 text-[#3d362f] dark:text-gray-300">ATS optimization</td>
                <td className="text-center py-4 px-4"><Check className="w-6 h-6 text-green-600 mx-auto" weight="bold" /></td>
                <td className="text-center py-4 px-4"><Check className="w-6 h-6 text-green-600 mx-auto" weight="bold" /></td>
              </tr>
              <tr className="border-b border-gray-100 dark:border-gray-900">
              ...
              <tr className="border-b border-gray-100 dark:border-gray-900">
                <td className="py-4 pr-4 text-[#3d362f] dark:text-gray-300">Resume templates</td>
                <td className="text-center py-4 px-4"><span className="text-sm text-[#9a8f85] dark:text-gray-400">Basic</span></td>
                <td className="text-center py-4 px-4"><Check className="w-6 h-6 text-green-600 mx-auto" weight="bold" /></td>
              </tr>
              <tr>
                <td className="py-4 pr-4 text-[#3d362f] dark:text-gray-300">Free forever plan</td>
                <td className="text-center py-4 px-4"><Check className="w-6 h-6 text-green-600 mx-auto" weight="bold" /></td>
                <td className="text-center py-4 px-4"><span className="text-sm text-[#9a8f85] dark:text-gray-400">7-day trial</span></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="mb-16 bg-secondary/5 border border-secondary/20 rounded-2xl p-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-secondary mb-2">WorthApply: Fit First</h3>
              <p className="text-[#3d362f] dark:text-gray-300">
                Analyze job alignment BEFORE investing hours tailoring. Our AI ensures resume improvements reflect your actual experience, not fabricated achievements.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-[#3d362f] dark:text-gray-300 mb-2">Rezi: Template First</h3>
              <p className="text-[#3d362f] dark:text-gray-300">
                Start from scratch with Professional templates. Strong focus on formatting and ATS compatibility, but less emphasis on strategic job selection.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border border-gray-200 dark:border-gray-800 rounded-2xl p-8">
              <h3 className="text-xl font-bold text-[#171411] dark:text-gray-100 mb-2">Rezi Pro</h3>
              <div className="text-4xl font-bold text-[#171411] dark:text-gray-100 mb-1">$29<span className="text-xl text-[#9a8f85] dark:text-gray-400">/mo</span></div>
              <p className="text-sm text-[#6e665f] dark:text-gray-400 mb-4">Unlimited resumes and automated generation</p>
              <p className="text-sm text-[#3d362f] dark:text-gray-300 mb-4">7-day free trial, then paid</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-gray-50 dark:bg-gray-900 rounded-2xl p-12">
          <h2 className="text-3xl lg:text-4xl font-extrabold text-[#171411] dark:text-gray-100 tracking-tight leading-[1.1] mb-4">
            Try a smarter approach to job applications
          </h2>
