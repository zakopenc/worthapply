        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-24 sm:pb-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="mt-16 relative animate-fade-in animation-delay-500">
              ...
              {/* Main dashboard preview - placeholder for now, replace with actual screenshot */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200 bg-white">
                {/* Mock dashboard UI */}
                <div className="bg-gradient-to-br from-[#fbf8f4] to-white p-8">
                  <div className="max-w-4xl mx-auto">
                    {/* Mock header */}
                    <div className="flex items-center justify-between mb-8">
                      <div className="text-sm text-[#6e665f]">Job Fit Analysis</div>
                      <div className="text-xs text-[#9a8f85]">Completed in 8 seconds</div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-8 shadow-lg mb-6">
                      <div className="flex items-center gap-6 mb-6">
                        <div className="relative">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center">
                              ...
                              <div className="text-xs text-[#6e665f]">Fit Score</div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex-1">
                          ...
                          <h3 className="text-xl font-bold text-[#171411] mb-2">Senior Product Manager</h3>
                          <p className="text-[#6e665f]">TechCorp • San Francisco, CA • $180k-$220k</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-4 pt-6 border-t border-gray-100">
                        <div>
                          ...
                          <div className="text-xs text-[#6e665f]">Skills Matched</div>
                        </div>
                        <div>
                          <div className="text-2xl font-bold text-[#171411]">5 years</div>
                          <div className="text-xs text-[#6e665f]">Experience Match</div>
                        </div>
                        <div>
                    ...
                    <div className="flex gap-2 flex-wrap">
                      {['Product Strategy', 'Roadmapping', 'Agile/Scrum', 'SQL', 'Analytics', 'A/B Testing'].map((skill) => (
                        <div key={skill} className="px-3 py-1.5 bg-green-50 text-green-700 rounded-lg text-sm font-medium">
                          ✓ {skill}
                        </div>
                      ))}
                      <div className="px-3 py-1.5 bg-gray-100 text-[#6e665f] rounded-lg text-sm">
                        +2 more
                      </div>
                    </div>
                  </div>
              ...
              {/* Floating result card overlay - animated */}
              <div className="absolute -bottom-6 -right-6 bg-white p-5 rounded-xl shadow-2xl border border-gray-200 animate-float hidden sm:block">
                <div className="flex items-center gap-4">
                  <div className="text-5xl font-bold text-green-600">92%</div>
                  <div className="text-sm">
                    <div className="font-bold text-[#171411]">High Fit Match</div>
                ...
                <table className="min-w-full divide-y divide-gray-200 bg-white">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th scope="col" className="px-6 py-4 text-center bg-green-50 border-x-2 border-green-600">
                        <div className="font-bold text-green-600 text-lg">WorthApply</div>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {[
                      ...
                      <tr key={idx} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        ...
                        <td className="px-6 py-4 text-center text-sm bg-green-50 border-x-2 border-green-600 font-semibold">
                          {row.worthapply}
                        </td>
            ...
            {[
              ...
              <FadeUp key={feature.title}>
                <HoverCard className="h-full">
                  <div className="group p-6 bg-white rounded-xl border border-gray-200 hover:border-secondary hover:shadow-xl transition-all duration-300 h-full">
                    ...
                    <h3 className="text-lg font-semibold text-[#171411] mb-2">{feature.title}</h3>
                    <p className="text-[#6e665f] text-sm leading-relaxed">{feature.description}</p>
                  </div>
                </HoverCard>
              </FadeUp>
            ))}
      ...
      <section className="py-24 bg-gradient-to-br from-on-background to-primary-container text-white">
        <RevealOnScroll className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Run your first fit analysis free. No credit card, no fabrication, no keyword stuffing &mdash;
            just an honest read on whether the role is worth your time.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/signup"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-gray-900 rounded-xl font-semibold text-lg hover:bg-[#fbf8f4] transition-all duration-200 hover:shadow-2xl hover:-translate-y-1"
            >
              Get started free
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" weight="bold" />
            </Link>
            <Link 
              href="/pricing"
              className="inline-flex items-center gap-2 px-8 py-4 border-2 border-white/30 text-white rounded-xl font-semibold text-lg hover:bg-white/10 transition-all duration-200"
            >
              View pricing
            </Link>
          </div>
